...
namespace FamilyManagementSoftware.Controllers
{
    public class MonthlyBudgetsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CategoryId,Month,BudgetAmount,ActualAmount")] MonthlyBudget monthlyBudget)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CategoryId,Month,BudgetAmount,ActualAmount")] MonthlyBudget monthlyBudget)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        public ActionResult MonthlyBudgetView(MonthlyBudgetViewModel model)
        {
            model.CategoryList = db.category;
            model.BudgetList = db.monthlyBudget;
